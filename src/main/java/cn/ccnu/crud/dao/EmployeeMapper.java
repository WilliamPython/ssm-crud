...
public interface EmployeeMapper {
	...
	List<Employee> selectByExampleWithDept(EmployeeExample example); // 按条件查询（带部门信息）

	Employee selectByPrimaryKeyWithDept(Integer empId); // 按主键查询（带部门信息）
}